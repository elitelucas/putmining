                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card overflow-hidden">
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Re-Password with PutMining.</p>
                                    </div>
                                </div>
                        ...
                        <div class="card-body pt-0"> 
                            ...
                            <div class="p-2">
                            <form class="form-horizontal" method="POST" action="{{ url('sendForgotpasswordEmail') }}">
                                @csrf
                                    <div class="form-group">
                                        <label for="email">Email</label>
                                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" value="{{ Request::get('email') }}"  id="email" placeholder="Enter email" autocomplete="email" autofocus>
                                        @error('email')
