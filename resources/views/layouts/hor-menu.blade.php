        ...
        <nav class="navbar navbar-light navbar-expand-lg topnav-menu">
            ...
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    ...
                    @if (Auth::user()->paid && !Auth::user()->blocked)
                        <li class="nav-item">
                            <a class="nav-link" href="/paid_blog">Paid Blogs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="/activeplays">Active Plays</a>
                        </li>
                        <li class="nav-item">
                    ...
                    @if (Auth::user()->is_admin)
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-manage" role="button"
                                ...
                                Manage <div class="arrow-down"></div>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="topnav-manage">
                                <a href="/blog?paid=0" class="dropdown-item">Public Blog</a></a>
                                <a href="/blog?paid=1" class="dropdown-item">Paid Blog</a>
                                <a href="/content" class="dropdown-item">Page & Mail Content</a>
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-pages">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                        ...
                                        <a href="/ecommerce-orders"
                                            class="dropdown-item">@lang('translation.Orders')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-contact">
                                        <a href="/contacts-grid"
                                            class="dropdown-item">@lang('translation.User_Grid')</a>
                                        <a href="/contacts-list"
                                            class="dropdown-item">@lang('translation.User_List')</a>
                            ...
                            <div class="dropdown-menu" aria-labelledby="topnav-components">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                        <a href="/icons-boxicons"
                                            class="dropdown-item">@lang('translation.Boxicons')</a>
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-map">
                                        <a href="/maps-google"
                                            class="dropdown-item">@lang('translation.Google_Maps')</a>
                                        <a href="/maps-vector"
                                            class="dropdown-item">@lang('translation.Vector_Maps')</a>
                                        <a href="/maps-leaflet"
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                        ...
                                        <a href="/pages-timeline"
                                            class="dropdown-item">@lang('translation.Timeline')</a>
